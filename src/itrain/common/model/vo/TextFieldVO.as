package itrain.common.model.vo
{
	...
	{
		[Bindable] public var caseSensitive:Boolean;
		[Bindable] public var password:Boolean;
		[Bindable] public var startText:String;
		[Bindable] public var targetText:String;
		[Bindable] public var backgroundAlpha:Number = 1.0;
		[Bindable] public var backgroundColor:uint;
		[Bindable] public var validateOnHotspot:Boolean = true;
		[Bindable] public var validateOnEnter:Boolean = true;
