package itrain.common.model.vo
{
	...
	{		
		...
		[Bindable] public var borderColor:uint;
		[Bindable] public var borderWidth:int;
		[Bindable] public var borderAlpha:Number;
		[Bindable] public var cornerRadius:int;
		[Bindable] public var fillColor:uint;
		[Bindable] public var fillAlpha:Number;
		[Bindable] public var animationSpeed:int;
		[Bindable] public var watchItVisible:Boolean;
		[Bindable] public var tryItVisible:Boolean;
